...
function institutions_listts_handler($params) {
  ...
  $query = 'SELECT * FROM `phonebook_api`.`institutions` WHERE `join_date` <= FROM_UNIXTIME('.$ts.')';
  $ins = $db->Query($query);
  ...
  $query = 'SELECT * FROM `phonebook_api`.`institutions_fields` WHERE 1';
  ...
  $query = 'SELECT *, UNIX_TIMESTAMP(`value`) as uts FROM `phonebook_api`.`institutions_data_dates` WHERE 1';
  ...
  $query = 'SELECT * FROM `phonebook_api`.`institutions_data_ints` WHERE 1';
  ...
  $query = 'SELECT * FROM `phonebook_api`.`institutions_data_strings` WHERE 1';
  ...
  $query = 'SELECT *, UNIX_TIMESTAMP(`value_to_date`) AS uvtd, UNIX_TIMESTAMP(`value_from_date`) AS uvfd FROM `phonebook_api`.`institutions_history`.WHERE UNIX_TIMESTAMP(`date`) <= '.$ts.' ORDER BY `date` ASC';
  $hist = $db->Query($query);
